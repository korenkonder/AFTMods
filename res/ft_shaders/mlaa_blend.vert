...
void main() {
    ...
    result_texcoord1 = tex + vec2( 0.0,  1.0) * g_texel_size.xy;
    result_texcoord2 = tex + vec2( 0.0, -1.0) * g_texel_size.xy;
    result_texcoord3 = tex + vec2( 1.0,  0.0) * g_texel_size.xy;
    result_texcoord4 = tex + vec2(-1.0,  0.0) * g_texel_size.xy;
}
