#version 430 core
// reduce_tex_reduce_2_alphamask.vert

#include "common_quad.glsl"

#define result_position (gl_Position)

layout(location = 0) out vec4 result_texcoord0; //xy=texcoord0, zw=texcoord2
layout(location = 1) out vec4 result_texcoord1; //xy=texcoord1, zw=texcoord3
