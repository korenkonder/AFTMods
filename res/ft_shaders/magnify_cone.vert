...
void main() {
    ...
    result_texcoord0.xy = tex + vec2(-0.4, -0.4) * g_texel_size.xy;
    result_texcoord0.zw = tex + vec2( 0.4, -0.4) * g_texel_size.xy;
    result_texcoord1.xy = tex + vec2(-0.4,  0.4) * g_texel_size.xy;
    result_texcoord1.zw = tex + vec2( 0.4,  0.4) * g_texel_size.xy;
}
