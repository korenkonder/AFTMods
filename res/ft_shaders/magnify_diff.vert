...
layout(location = 2) out vec2 result_texcoord2; //xy=texcoord4
...
void main() {
    ...
    result_texcoord0.xy = tex;
    result_texcoord0.zw = tex + vec2(-0.7, -0.7) * g_texel_size.xy;
    result_texcoord1.xy = tex + vec2( 0.7, -0.7) * g_texel_size.xy;
    result_texcoord1.zw = tex + vec2(-0.7,  0.7) * g_texel_size.xy;
    result_texcoord2.xy = tex + vec2( 0.7,  0.7) * g_texel_size.xy;
}
