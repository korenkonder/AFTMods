...
void main() {
    ...
    result_texcoord0.zw = tex + vec2(-0.5,  0.866) * g_texel_size.xy;
    result_texcoord1.xy = tex + vec2(-0.5, -0.866) * g_texel_size.xy;
    result_texcoord1.zw = tex + vec2( 1.0,    0.0) * g_texel_size.xy;
}
