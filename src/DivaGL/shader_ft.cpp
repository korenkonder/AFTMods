...
const int32_t shader_ft_shader_name_map_table[] = {
    SHADER_FT_FFP,
    SHADER_FT_BLINN,
    SHADER_FT_ITEM,
    SHADER_FT_STAGE,
...
const size_t shader_ft_shader_name_map_table_size =
    sizeof(shader_ft_shader_name_map_table) / sizeof(int32_t);
...
static void glass_eye_set(p_gl_rend_state& p_gl_rend_st, glass_eye_struct* glass_eye) {
    ...
    *(vec2*)&glass_eye_batch.g_tex_scale
    ...
    p_gl_rend_st.write_uniform_buffer(rctx->glass_eye_batch_ubo, glass_eye_batch);
