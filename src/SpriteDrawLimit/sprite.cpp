...
HOOK(void, FASTCALL, spr__SprArgs__SetVertexArray, 0x000000014063F040, __int64 This, spr::SpriteVertex* vertex_array, size_t num_vertex) {
    ...
    *(size_t*)(This + 0xB0) = sprite_vertex_array_count;
    memmove(sprite_vertex_data.array + *(size_t*)(This + 0xB0), vertex_array, sizeof(spr::SpriteVertex) * num_vertex);
